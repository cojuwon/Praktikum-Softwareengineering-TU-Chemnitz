...
interface StatistikFilterSectionProps {
  ...
  onSubmit: () => void;
  // Callback to reload presets in parent
    ...
    <section className="bg-white px-10 pb-8 mx-5 rounded-b-xl shadow-sm">
      ...
      <div className="mt-8 pt-4 border-t flex justify-end gap-3">
        <button
          ...
          className="px-4 py-2 text-blue-600 font-medium hover:bg-blue-50 rounded-lg transition-colors border border-transparent hover:border-blue-100"
        >
