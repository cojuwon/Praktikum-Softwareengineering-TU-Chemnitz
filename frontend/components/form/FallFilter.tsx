...
export function FallFilter({ definition, onSearch }: Props) {
    ...
    const mitarbeiterOptions = resolveOptions(definition.find((f) => f.name === "mitarbeiterin")?.options);
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <MultiSelect
                    ...
                    selected={filters.mitarbeiterin}
                    onChange={(val) => update("mitarbeiterin", val)}
                />
            </div>
